...
public class PersonalPage extends CommonAPI{
    ...
    @FindBy(css = ".//*[@id='1434870673699']/div/div/div/ul/li/div[1]/div/ul/li/a/span[1]")
    ...
    public static void learnMor(){
        boolean lm=learnMore.isDisplayed();
        System.out.println("Learn More: " + lm);
    }
